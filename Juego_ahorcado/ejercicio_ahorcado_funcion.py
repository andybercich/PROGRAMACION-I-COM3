import random
from funcion_dibujo import drawing
...
"""
print("BIENVENIDO AL AHORCADO DE PYTHON DE ANDRÉS, TIENES 6 INTENTOS PARA ERRAR, TEN EN CUENTA QUE UNA LETRA REPETIDA ES UN ERROR")
